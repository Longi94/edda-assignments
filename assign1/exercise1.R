...
hist(x1,freq = FALSE); lines(density(x1), col = "red", lwd = 2)
qqnorm(x1); qqline(x1)
...
hist(x2, col = "blue", freq = FALSE); lines(density(x2), col = "red", lwd = 2)
qqnorm(x2); qqline(x2)

x2_testNorm = rnorm(length(x2))
hist(x2_testNorm,  freq = FALSE); lines(density(x2_testNorm), col = "red", lwd = 2)
...
#hist(x3)
hist(x3, freq = FALSE); lines(density(x3), col = "red", lwd = 2)
qqnorm(x3); qqline(x3)
 

x3_testNorm = rnorm(length(x3))
hist(x3_testNorm,  freq = FALSE); lines(density(x3_testNorm), col = "red", lwd = 2)
...
hist(x4,  freq = FALSE); lines(density(x4), col = "red", lwd = 2)
qqnorm(x4); qqline(x4)

x4_testNorm = rnorm(length(x4))
hist(x4_testNorm, freq = FALSE); lines(density(x4_testNorm), col = "red", lwd = 2)
...
hist(x5,  freq = FALSE); lines(density(x5), col = "red", lwd = 2)
qqnorm(x5); qqline(x5)

x5_testNorm = rnorm(length(x5))
hist(x5_testNorm,  freq = FALSE); lines(density(x5_testNorm), col = "red", lwd = 2)
